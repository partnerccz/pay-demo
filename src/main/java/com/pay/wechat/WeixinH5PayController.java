...
import com.pay.model.PayOrderResult;
import com.pay.model.PayResult;
import com.pay.model.enums.PayOrderField;
import com.pay.model.enums.ResultCode;
import com.pay.util.*;
...
public class WeixinH5PayController {
    ...
    private JSONObject genJsParam(PayResult payResult) {
        ...
        // 计算sign
        data.put("paySign", SignUtil.sign(data, apiKey));
